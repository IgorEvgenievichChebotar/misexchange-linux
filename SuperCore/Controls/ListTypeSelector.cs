...
{
    /*class ListTypeSelector : UITypeEditor
    {
        ...
        public override object EditValue(System.ComponentModel.ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            if ((context != null) && (provider != null))
            {
                try
                {
                    ...
                    var objectNames = Enum.GetNames(typeof(ListTypes));
                    ...
                    if (edSvc != null)
                    {
                        ...
                        value = (int)Enum.Parse(typeof(ListTypes), lbObjects.SelectedItem.ToString());
                    }
                }
                catch (Exception)
                { }
