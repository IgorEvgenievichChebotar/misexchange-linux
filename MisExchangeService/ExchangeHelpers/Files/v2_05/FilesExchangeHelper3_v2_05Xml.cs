...
{
    [ExchangeHelperName("FilesExchangeHelper3_v2_05+_Xml")]
    public class FilesExchangeHelper3_v2_05Xml : ExchangeHelper3
    {
        private HelperSettings helperSettings = new HelperSettings();

        public FilesExchangeHelper3_v2_05Xml()
        {
            ...
            FilesExchange2_05Parser.HelperSettings = helperSettings;
        }
        ...
        protected virtual ExchangeDTOs.Request ReadRequest(String fileName)
        {
            return File.ReadAllText(fileName, Encoding.UTF8).Deserialize<ExchangeDTOs.Request>(Encoding.UTF8);
        }
        ...
        private void ProcessFile(String fileName)
        {
            ...
            try
            {
                requestDTO = ReadRequest(fileName);
        ...
        protected override bool IsFilterRequestResults { get { return helperSettings.IsFilterRequestResults; } }
        ...
        protected virtual void WriteResult(ExchangeDTOs.Result result, String fileName)
        {
            File.WriteAllText(fileName, result.Serialize(Encoding.UTF8).RemoveNilElements(), Encoding.UTF8);
        }

        protected virtual void SpecificPrepareResult(ExchangeDTOs.Result result)
        {
            //
        }
        ...
        {
            FilesExchange2_05Parser.PrepareResult(result);

            SpecificPrepareResult(result);
            ...
            WriteResult(result, tempFileName);
            destFileName = Path.ChangeExtension(tempFileName, ".xml");
